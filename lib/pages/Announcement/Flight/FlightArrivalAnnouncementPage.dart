...
class FlightArrivalAnnouncementPage extends StatefulWidget {
  ...
  @override
  _FlightArrivalAnnouncementPageState createState() => _FlightArrivalAnnouncementPageState();
}

class _FlightArrivalAnnouncementPageState extends State<FlightArrivalAnnouncementPage> {
  ...
  final TextEditingController _arrivalTerminalController = TextEditingController();
  final TextEditingController _baggageClaimController = TextEditingController();
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
              ...
              children: [
                Expanded(
                  child: _buildDatePicker(
                    label: 'Arrival Date',
                    value: _arrivalDate?.toString().split(' ')[0],
                    onTap: () async {
            ...
            // Arrival Terminal
            _buildTextFormField(
              controller: _arrivalTerminalController,
    ...
    if (_formKey.currentState?.validate() ?? false) {
      if (_arrivalDate == null || _arrivalTime == null) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Please select arrival date and time'),
